...
const EmailCaptureModal: React.FC<EmailCaptureModalProps> = ({ isOpen, onSubmit, isProcessing }) => {
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full ring-1 ring-gray-200">
                ...
                <form onSubmit={handleSubmit} className="mt-6">
                 ...
                 <div className="text-xs text-gray-400 mt-4 text-center">
                    <p>Usaremos tu correo para guardar tus proyectos y notificarte sobre novedades.</p>
                </div>
            </div>
        </div>
    );
